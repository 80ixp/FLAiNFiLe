...
if text == 'مطور السورس' or text == 'مطور فلاين' then
TextReply = '[• MUSTAFA •](t.me/vXvvv)'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'مبرمج فلاين' or text == 'مبرمج السورس' then
TextReply = '[• MUSTAFA •](t.me/vXvvv)'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'منو المطور' or text == 'منو مطور' then
TextReply = '[• MUSTAFA •](t.me/vXvvv) حبيبي هذا مطور السورس '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'هلو' then
